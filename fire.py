...
def get_rotation(chore: str) -> (list[list], str):
    ...
    try:
        ...
        print('Start date was not found. Using default')
...
def calculate_duty(rotation, start_date, interval='week') -> int:
    ...
    difference = datetime.now() - start_date
...
# data = {
#     "startDate": datetime.strptime('Dec 26, 2022', '%b %d, %Y')
#     }
...
chore_ref = db.collection('chores').document('groceries')

chore_snapshot = chore_ref.get(timeout=50000).to_dict()

print(chore_snapshot)
